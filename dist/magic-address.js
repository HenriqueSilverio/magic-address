/*!
 * magic-address - 1.1.0
 * https://github.com/HenriqueSilverio/magic-address
 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MagicAddress"] = factory();
	else
		root["MagicAddress"] = factory();
...
var _es6Promise = _interopRequireDefault(__webpack_require__(1));

var _objectAssign = _interopRequireDefault(__webpack_require__(4));
...
var MagicAddress = {
  ...
  start: function start() {
    ...
    this.settings = (0, _objectAssign.default)({}, this.DEFAULTS, options);
  ...
  _queryAPI: function _queryAPI(cep) {
    ...
    return new _es6Promise.default(function (resolve, reject) {
      ...
      request.open('GET', "".concat(_this.settings.API, "/").concat(cep));
